<?php
    ...
    class usuarioControlador extends usuarioModelo{
        ...
        public function agregar_usuario_controlador(){
            ...
            if(mainModel::verificar_datos("[a-zaA-ZáéíóúÁÉÍÓÚñÑ ]{1,35",$nombre)){
                $alerta=[
                    "Alerta"=>"simple",
                    "Titulo"=>"Ocurrio un error inesperado",
            ...
            if(mainModel::verificar_datos("[a-zaA-ZáéíóúÁÉÍÓÚñÑ ]{1,35",$apellido)){
                $alerta=[
                    "Alerta"=>"simple",
                    "Titulo"=>"Ocurrio un error inesperado",
            ...
            if($direccion!=""){
                if(mainModel::verificar_datos("[a-zaA-ZáéíóúÁÉÍÓÚñÑ ]{1,190}",$direccion)){
                    $alerta=[
                        "Alerta"=>"simple",
                        "Titulo"=>"Ocurrio un error inesperado",
                        "Texto" =>"El TELEFONO no coincide con el formato solicitado",
            ...
            if(mainModel::verificar_datos("[a-Az-Z0-9]{1,35",$usuario)){
                $alerta=[
                    "Alerta"=>"simple",
                    "Titulo"=>"Ocurrio un error inesperado",
            ...
            if(mainModel::verificar_datos("[a-Az-Z0-9$@.-]{7,100}",$clave1) || 
                mainModel::verificar_datos("[a-Az-Z0-9$@.-]{7,100}",$clave2)){
                $alerta=[
                    "Alerta"=>"simple",
                    "Titulo"=>"Ocurrio un error inesperado",
            ...
            //comprobando usuario
            $check_dni=mainModel::ejecutar_consulta_simple("SELECT usuario_usuario FROM usuario WHERE usuario_usuario='$usuario'");
            if($check_dni->rowCount()>0){
                $alerta=[
                    "Alerta"=>"simple",
                    "Titulo"=>"Ocurrio un error inesperado",
